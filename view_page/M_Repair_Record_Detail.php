...
<html>
    <head>
        ...
        <title>รายละเอียดรายการซ่อม</title>
        <style>
            .dataTables_filter{
                display: none;
            }
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <span class="fa fa-info-circle"></span> รายละเอียดรายการซ่อมเลขที่สินค้าซ่อม : <label><?= $_GET['item_id']; ?> </label>
            </h1>
            <ol class="breadcrumb">
                <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                <li><a href="M_MyWork.php">งานซ่อมของฉัน</a></li>
                <li class="active">รายละเอียดรายการซ่อม</li>
            </ol>
        </section>
                    ...
                    <div class="box box-default">
                        ...
                        <div class="content">
                            <div class="box-body">
                                ...
                                <table class="table table-hover" id="repair_detail">
                                </table>
                            </div>
                            <div class="box-body">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="30%" style="text-align:center; vertical-align: middle;">
                                                <div class="btn-group">
                                                    <button type="button" class="btn bg-green-gradient dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" disabled=""><span class="fa fa-plus-square"></span> เพิ่มงานซ่อมสินค้า</button>
    ...
    <script>
        ...
        $(function () {
            ...
            tableList = $("#repair_list").DataTable({
                ajax: {
                    url: "ajax/mywork/select_repair_list_table_detail.php",
                    type: "post",
