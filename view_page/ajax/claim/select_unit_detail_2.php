...
$sql = 'SELECT * FROM t_claim_exchange WHERE ORD_ID = "' . $ord_id . '" AND Unit_ID_New = "' . $unit_id . '"';
...
echo '                                  <tbody>
                                        <tr>
                                            ...
                                            <td width="35%" colspan="2"><input type="text" class="form-control" id="ex_unit_id_old" name="ex_unit_id_old" value="' . $result['Unit_ID_New'] . '" required="" readonly="" /></td>
                                        </tr>
                                        <tr>
