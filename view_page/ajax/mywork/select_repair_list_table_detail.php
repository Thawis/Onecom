...
while ($result = $stmt->fetch()) {
    if ($result['Repair_Type'] == "Menu") {
        ...
        $action = '<button type="button" class="btn bg-red-gradient btn_remove_list" value="' . $result['Case_Number'] . '" disabled=""><span class="fa fa-close"></span></button>';
        ...
        $action = '<button type="button" class="btn bg-aqua-gradient btn_detail_sell" value="'.$result['Ref_ID_Sell'].'"><span class="fa fa-info-circle"></span></button> '
                . '<button type="button" class="btn bg-red-gradient btn_remove_list_sell" value="' . $result['Ref_ID_Sell'] . '" disabled=""><span class="fa fa-close"></span></button>';
